...
/** Pizza shop menu with images. Image URLs use Unsplash placeholders; replace with your own or local /images/ paths. */
export const MENU_ITEMS: MenuItem[] = [
  // 披薩 (reference: Domino's style - https://www.dominos.ca/en/pages/order/menu#!/menu/category/pizza/)
