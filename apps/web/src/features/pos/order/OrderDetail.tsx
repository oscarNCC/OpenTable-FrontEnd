...
import type { OrderRecord, OrderUpdateBody } from '../../../shared/api';
import { getOrderById, updateOrder } from '../../../shared/api';
import { MENU_ITEMS } from '../data/menu';
import { formatPizzaOptionsSummary } from './formatPizzaOptions';

const TABLE_OPTIONS = [
  { id: '00000000-0000-0000-0000-000000000004', name: 'Guest' },
  { id: 't1', name: '1 號枱' },
  { id: 't2', name: '2 號枱' },
  { id: 't3', name: '3 號枱' },
];
                      ...
                      <li key={`${line.menuItemId}-${idx}`} className="order-detail-line">
                        ...
                        {line.pizzaOptions ? (
                          <p className="order-detail-line-options">
                            {formatPizzaOptionsSummary(line.pizzaOptions as PizzaOptions)}
                          </p>
                        ) : null}
                      </li>
                    ))}
